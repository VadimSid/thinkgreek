...
function bon_styles() {
    if (!is_admin()) {
        ...
        if(current_theme_supports('bootstrap')) {
        	...
        	wp_register_style( 'bootstrap', trailingslashit( BON_CSS ) . 'frontend/bootstrap.css', array(), '', 'screen');
        	wp_register_style( 'bootstrap-responsive', trailingslashit( BON_CSS ) . 'frontend/bootstrap-responsive.css', array(), '', 'screen' );
        	wp_enqueue_style( 'bootstrap');
        	wp_enqueue_style( 'bootstrap-responsive' );

        }

        wp_register_style( 'gallery-carousel', trailingslashit( BON_CSS ) . 'frontend/gallery-carousel.css', array(), '', 'screen' );
        ...
        wp_register_style( 'bonicons', trailingslashit( BON_CSS ) . 'frontend/bonicons.css', array(), false, 'all' );

        wp_enqueue_style( 'bonicons' );

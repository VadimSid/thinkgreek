...
function theme_layouts_strings() {
	...
	$strings = array(
		'default' => __( 'Default', 'bon' ),
		'1c'      => __( 'One Column', 'bon' ),
		'2c-l'    => __( 'Two Columns, Left', 'bon' ),
		'2c-r'    => __( 'Two Columns, Right', 'bon' ),
		'3c-l'    => __( 'Three Columns, Left', 'bon' ),
		'3c-r'    => __( 'Three Columns, Right', 'bon' ),
		'3c-c'    => __( 'Three Columns, Center', 'bon' )
	);
...
function theme_layouts_add_meta_boxes( $post_type, $post ) {
	...
	if ( ( post_type_supports( $post_type, 'theme-layouts' ) ) && ( current_user_can( 'edit_post_meta', $post->ID ) || current_user_can( 'add_post_meta', $post->ID ) || current_user_can( 'delete_post_meta', $post->ID ) ) )
		add_meta_box( 'theme-layouts-post-meta-box', __( 'Layout', 'bon' ), 'theme_layouts_post_meta_box', $post_type, 'side', 'default' );
}
...
function theme_layouts_customize_register( $wp_customize ) {
	...
	if ( true === $args['customize'] ) {
		...
		$wp_customize->add_control(
			...
			array(
				'label'    => esc_html__( 'Global Layout', 'bon' ),
				'section'  => 'layout',

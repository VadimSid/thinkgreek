...
function bon_custom_admin_footer() {
  echo apply_filters('bon_custom_admin_footer', '<span id="footer-thankyou">Developed by <a href="http://bonfirelab.com" target="_blank">Bonfirelab</a> Powered by <a href="http://wordpress.org" target="_blank">wordpress</a></span>.');
}

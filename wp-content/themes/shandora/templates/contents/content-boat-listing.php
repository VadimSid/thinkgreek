...
?>
<article id="post-<?php the_ID(); ?>" <?php post_class( $status . ' listing'  ); ?> itemscope itemtype="http://schema.org/AutoDealer">
...
<li class="<?php echo $li_class; ?>">
	<article id="post-<?php the_ID(); ?>" <?php post_class( $badgeclr ); ?> itemscope itemtype="http://schema.org/Product">

	...
	<div class="entry-content clear" itemprop="description">
		...
		?>	
			...
			<div class="column large-8 small-8">
				<?php if( !empty( $agent_mobile ) || !empty( $agent_office) || !empty( $agent_fax) || !empty( $agent_fb ) || !empty( $agent_li ) || !empty( $agent_tw ) ) { ?>
				<div class="row">
					...
					<?php endif; ?>
					<?php if( !empty( $agent_fb ) || !empty( $agent_li ) || !empty( $agent_tw ) ) : ?>
...
<div id="agent-listings">
	<h3><?php printf(__('Latest Listings by %s','bon'), get_the_title(get_the_ID())); ?></h3>

...
class Shandora_dsIDXpress_Search extends WP_Widget {
	...
	function update($new_instance, $old_instance) {
		...
		if($new_instance["searchOptions"]["show_pricerange"] == "on") $new_instance["searchOptions"]["show_pricerange"] = "yes";
		else $new_instance["searchOptions"]["show_pricerange"] = "no";

		if($new_instance["searchOptions"]["show_beds"] == "on") $new_instance["searchOptions"]["show_beds"] = "yes";
		else $new_instance["searchOptions"]["show_beds"] = "no";

		if($new_instance["searchOptions"]["show_bath"] == "on") $new_instance["searchOptions"]["show_bath"] = "yes";
		else $new_instance["searchOptions"]["show_bath"] = "no";

		if($new_instance["searchOptions"]["show_size"] == "on") $new_instance["searchOptions"]["show_size"] = "yes";
		else $new_instance["searchOptions"]["show_size"] = "no";
	...
	function form($instance) {
		...
		$show_pricerange = $instance["searchOptions"]["show_pricerange"] == "yes" ? "checked=\"checked\" " : "";
		$show_beds = $instance["searchOptions"]["show_beds"] == "yes" ? "checked=\"checked\" " : "";
		$show_bath = $instance["searchOptions"]["show_bath"] == "yes" ? "checked=\"checked\" " : "";
		$show_size = $instance["searchOptions"]["show_size"] == "yes" ? "checked=\"checked\" " : "";
		...
		?>
			...
			<p>
				...
				<div id="<?php echo $searchOptionsFieldId; ?>-show_checkboxes" class="search-widget-searchOptions">
					...
					<input type="checkbox" id="<?php echo $searchOptionsFieldId; ?>-show_pricerange" name="<?php echo $searchOptionsFieldName; ?>[show_pricerange]" <?php echo $show_pricerange; ?> onclick="dsWidgetSearch.ShowBlock(this);"/>
					<label for="<?php echo $searchOptionsFieldId; ?>-show_pricerange">Price</label><br />
					<input type="checkbox" id="<?php echo $searchOptionsFieldId; ?>-show_beds" name="<?php echo $searchOptionsFieldName; ?>[show_beds]" <?php echo $show_beds; ?> onclick="dsWidgetSearch.ShowBlock(this);"/>
					<label for="<?php echo $searchOptionsFieldId; ?>-show_beds">Bed</label><br />
					<input type="checkbox" id="<?php echo $searchOptionsFieldId; ?>-show_bath" name="<?php echo $searchOptionsFieldName; ?>[show_bath]" <?php echo $show_bath; ?> onclick="dsWidgetSearch.ShowBlock(this);"/>
					<label for="<?php echo $searchOptionsFieldId; ?>-show_bath">Bath</label><br />
					<input type="checkbox" id="<?php echo $searchOptionsFieldId; ?>-show_size" name="<?php echo $searchOptionsFieldName; ?>[show_size]" <?php echo $show_size; ?> onclick="dsWidgetSearch.ShowBlock(this);"/>
					<label for="<?php echo $searchOptionsFieldId; ?>-show_size">Size</label><br />

...
if( !function_exists('bon_set_theme_options') ) {
	...
	function bon_set_theme_options() {
		...
		$boat_search_fields = apply_filters( 'bon_boat_search_field_options', array(
			'boat_reg' => __('Boat Reg Number Field', 'bon'),
			'boat_status' => __('Boat Condition Dropdown','bon'),
			'boat_make' => __('Boat Make', 'bon'),
			'boat_model' => __('Boat Model', 'bon'),
			'boat_submodel' => __('Boat Sub Model', 'bon'),
			'boat_engine_make' => __('Boat Engine Make', 'bon'),
			'boat_engine_model' => __('Boat Engine Model', 'bon'),
			'boat_engine_submodel' => __('Boat Engine Sub Model', 'bon'),
			'boat_location' => __('Boat Dealer Location Dropdown ', 'bon'),
			'boat_location_level1' => __('Boat Level 1 Dealer Location Only ', 'bon'),
			'boat_location_level2' => __('Boat Level 2 Dealer Location Only ', 'bon'),
			'boat_location_level3' => __('Boat Level 3 Dealer Location Only ', 'bon'),
			'boat_feature' => __('Boat Boat Feature Dropdown', 'bon'),
			'boat_yearbuilt' => __('Boat Year Built', 'bon'),
			'boat_hull' => __('Boat Hull Material', 'bon'),
			'boat_fuel' => __('Boat Fuel Type', 'bon'),
			'boat_price' => __('Boat Price Range Slider', 'bon'),
		));
		...
		$options[] = array( 'slug' => 'bon_options',
							'label' => __( 'Show Previous / Next link on pages', 'bon' ),
		                    'desc' => __('If enabled the it will show previous and next link on the page','bon'),
		                    'id' => 'show_previous_next',
		                    'type' => 'select',
		                    'options' => array(
		                    	'no' => __('Show','bon'),
		                    	'yes' => __('Hide','bon'),
		...
		$options[] = array( 'slug' => 'bon_options',
							'label' => __( 'Secondary Price end text', 'bon' ),
		                    'desc' => __('Additional text for the secondary price end, eq: without tax.','bon'),
		                    'id' => 'secondary_price_end',
		                    'type' => 'text',
		                    );
		...
		$options[] = array( 'slug' => 'bon_options',
							'label' => __( 'Show Listing Meta Data Icons', 'bon' ),
		                    'desc' => __('Show the meta data boxes with icons and details.','bon'),
		                    'id' => 'show_listing_meta',
		                    'type' => 'select',
		                    'options' => array(
		                    	'yes' => __('Yes','bon'),
		                    	'no' => __('No','bon'),
		...
		$options[] = array( 'slug' => 'bon_options',
							'label' => __( 'Listing box Item', 'bon' ),
		                    'desc' => __('Choose which one of the button you want to show in the listing overlay and listing box item if enabled.','bon'),
		                    'id' => 'overlay_buttons',
		                    'std' => array(
			                    	'link' => true,
			                    	'gallery' => true,
		                    ...
		                    'options' => array(
			                    	...
			                    	'icon'	=> __('Meta Icon', 'bon'),
			                    	'thumbnail' => __('Thumbnail', 'bon'),
			                    )
		                    );
		...
		$options[] = array( 'slug' => 'bon_options',
							'label' => __( 'Maximum Total Room Options', 'bon' ),
		                    'desc' => __('The maximum total room available for user to select in search field.','bon'),
		                    'id' => 'maximum_room',
		                    'type' => 'text' );
		...
		$options[] = array( 'slug' => 'bon_options',
							'label' => __( 'Set 1 agent for all Real Estate listings', 'bon' ),
		                    'desc' => __('Set a global agent to connected in all real estate listings','bon'),
		                    'id' => 'global_agent',
		...
		$options[] = array( 'slug' => 'bon_options', 'label' => __( 'Instagram Username', 'bon' ),
		    				'desc' => __( 'Your Instagram username.', 'bon' ),
		    				'id' => 'social_instagram',
		    				'std' => '',
		    				'type' => 'text' );

		$options[] = array( 'slug' => 'bon_options', 'label' => __( 'Yelp User ID', 'bon' ),
		    				'desc' => __( 'Your Yelp user id.', 'bon' ),
		    				'id' => 'social_yelp',
		    				'std' => '',
		    				'type' => 'text' );
